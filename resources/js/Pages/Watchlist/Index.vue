        ...
        <div class="p-2 lg:p-10 xl:px-15 xl:py-10">
            <div class="w-full">
                <div class="w-full flex justify-between items-center">
                    <div class="flex">
                        <h2
                            class="font-semibold tracking-wider text-2xl text-gray-700 dark:text-gray-400"
                        >
                            Watchlists
                        </h2>
                    </div>
                    ...
                    <div
                        class="flex justify-betweeen items-center gap-2 text-base tracking-wide font-semibold"
                    >
                        <BaseButton
                            variant="filter"
            ...
            <section class="mt-5">
                ...
                <div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-5">
                    ...
                    >
                        <div
                            class="w-18 h-27 sm:w-28 sm:h-37 lg:w-30 lg:h-42.5"
                        >
                            <img
                        ...
                        <div class="flex-1 flex flex-col justify-between">
                            <div>
                                <h3
                                    class="text-sm lg:text-base cursor-pointer line-clamp-1 text-gray-800 dark:text-gray-300 font-semibold tracking-wide mb-1"
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="flex gap-0.5 items-center">
                                        ...
                                        <span
                                            class="text-sm lg:text-base text-gray-800 dark:text-gray-300"
                                            >{{
                                                formattedScore(
                                                    watchlist.score,
                                                ).toFixed(1)
                                ...
                                >
                                    <span
                                        ...
                                        >Episode
                                        {{ watchlist.lastWatchedEpisode }} of
                                        {{ watchlist.episodes }}</span
                                    >
                                    <div
                                        class="flex items-center lg:items-end gap-2"
                                    >
                                        <div
                                            class="h-3 lg:h-4.5 bg-gray-400 w-1/2"
                                        >
                                            <div
                                                :style="{
                                                    width:
                                                        watchlist.lastWatched +
                                                        '%',
                                                }"
                                        ...
                                        <div
                                            class="w-1/2 text-gray-800 dark:text-gray-300"
                                        >
                                            {{
                                                Math.floor(
                                                    watchlist.lastWatched,
                                ...
                                <div
                                    ...
                                    "
                                    class="text-sm lg:text-base flex gap-1 mt-1 text-gray-800 dark:text-gray-300"
                                >
                                    <span
                                        v-for="(
                                            genre, index
                                        ) in watchlist.genres.slice(0, 3)"
                                        :key="index"
                                ...
                                <div
                                    ...
                                    class="rounded w-26 text-center text-gray-100 p-1 inline-block text-[10px] font-bold uppercase tracking-widest lg:mt-2"
                                >
                            ...
                            <div class="mt-auto flex justify-between w-full">
                                <button
                                    v-if="
                                        ...
                                        watchlist.lastWatched !== null
                                    "
                                    class="text-xs lg:text-sm rounded-full cursor-pointer font-medium tracking-wide border px-1 py-0.5 lg:px-2 lg:py-1 text-gray-700 dark:text-gray-400 border-gray-400 dark:border-gray-700"
                                    @click="
                                        continueWatching(
                                            watchlist.anilistId,
                                ...
                                <button
                                    ...
                                    class="text-xs lg:text-sm rounded-full cursor-pointer font-medium tracking-wide border px-1 py-0.5 lg:px-2 lg:py-1 text-gray-700 dark:text-gray-400 border-gray-400 dark:border-gray-700"
                                    @click="
                                        watchEpisode(watchlist.anilistId, 1)
                                    "
                                >
                                    Start Watching
                                </button>
                                ...
                                <div class="flex gap-1">
                                    <button
                                        @click="
                                            toggleFavorite(watchlist.anilistId)
                                        "
                                    >
                                        <HeartIcon
                                            :class="
                    ...
                    <div
                        v-if="
                            activeTab === 'all' && countAnimeStatus('all') === 0
                        "
                    >
                        <p
