<template>
    ...
    <div class="flex flex-col items-center">
        <div class="w-full max-w-115 flex my-10 flex-col items-center">
            ...
            <BaseText>
                Begin your dive and explore thousands of anime.
            </BaseText>
            ...
            >
                <div class="mb-3">
                    <label
                        class="block uppercase text-xs tracking-wide font-semibold text-gray-600 dark:text-gray-400 mb-1.5"
                        >Username</label
                    >
                    <input
                        ...
                        placeholder="Vegeta77"
                        required
                    />
                    <small
                        v-if="form.errors.username"
                        class="text-red-400 tracking-wide font-medium block ml-1 mt-1"
                    >
