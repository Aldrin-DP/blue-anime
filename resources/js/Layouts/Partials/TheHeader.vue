<template>
    ...
    >
        <header
            class="max-w-325 w-full lg:flex lg:mx-10 xl:mx-15 lg:items-center"
        >
            <div
                class="flex h-18 justify-between items-center w-full px-3 lg:w-auto lg:px-0"
            >
                <AppLogo />
                ...
                <div class="lg:hidden flex justify-between items-center gap-5">
                    ...
                    <button
                        @click="toggleNav"
                        class="lg:hidden cursor-pointer border border-transparent px-1 py-1 hover:text-gray-700 hover:border-gray-300 hover:dark:border-gray-800 hover:dark:text-gray-100 hover:shadow-lg hover:shadow-gray-300 hover:dark:shadow-gray-900 transition-all duration-300"
                    >
            ...
            >
                ...
                >
                    <div
                        class="flex flex-col items-center lg:flex-row lg:gap-2"
                    >
                        <NavLink class="w-full lg:w-auto" href="/">
                            Surface
                        </NavLink>
                        <NavLink class="w-full lg:w-auto" href="/explore">
                            Explore</NavLink
                        >
                    </div>

                    <div
                        class="flex flex-col items-center lg:justify-between gap-2 mt-4 lg:mt-0 pt-3 lg:pt-0 border-t border-gray-300 dark:border-gray-800 lg:flex-row lg:border-none"
                    >
                        ...
                        <NavLink
                            ...
                            href="/login"
                            class="flex items-center justify-center w-full lg:w-auto gap-1"
                        >
                        ...
                        <div class="w-full lg:w-auto relative">
                            ...
                            >
                                <div
                                    ...
                                    class="lg:px-4 lg:py-1.5 flex items-center gap-2 pb-3 border-b border-gray-300 dark:border-gray-700 lg:border-none"
                                >
                                    <p
                                        class="px-2 bg-blue-700 rounded-full text-gray-300 font-bold text-lg"
                                    >
                                        {{ username.charAt(0).toUpperCase() }}
                                    </p>
                                    <h4 class="lg:max-w-24 truncate">
                                        {{ username }}
                                    </h4>
                                </div>
                                <div
