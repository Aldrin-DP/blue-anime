<template>
  <div
    class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 lg:gap-5"
  >
    <div
    ...
    >
      ...
      <h3 class="text-gray-700 dark:text-gray-300 font-semibold truncate mt-1">
