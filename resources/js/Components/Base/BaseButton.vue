...
export default {
    ...
    computed: {
        btnClasses() {
            return [
                'cursor-pointer px-5 py-2 rounded-full font-bold text-gray-200 bg-gray-600 text-sm',
                {
                    ...
                    'bg-gradient-to-b from-red-700 to-red-900 hover:opacity-90 transition-all duration-300': this.variant === 'danger',
                },
            ];
        }
    }
